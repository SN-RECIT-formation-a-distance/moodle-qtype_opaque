...
class engine_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventengine_deleted', 'qtype_webwork_opaque');
    }

    public function get_description() {
        return "The user with id {$this->userid} deleted the webwork_opaque question engine with id {$this->objectid}.";
    }

    public function get_url() {
        return new \moodle_url('/question/type/webwork_opaque/engines.php?');
    }
