...
$string['couldnotgetquestionmetadata'] = "L'engin de questions n'a pas été en mesure de retourner le score maximal pour la question. Ëtes vous sur que les ID et version distantes sont correctes? (Information technique: {$a})";
...
$string['questionhint_help'] = "Indiquer le nombre de tentatives avant d'afficher l'indice. Utilisez 0 pour ne pas afficher l'indice.";
$string['questionsolution'] = "Nombre de tentatives avant de verrouiller la question et afficher la solution";
$string['questionsolution_help'] = "Indiquer le nombre de tentatives avant de verrouiler la question et afficher la solution. Utilisez 0 pour ne pas afficher la solution.";
